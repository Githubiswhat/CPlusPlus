...
string AppConfig::basic_path = "resources/";
string AppConfig::texture_path = basic_path + "png/texture.png";
string AppConfig::levels_path = basic_path + "levels/";
string AppConfig::font_name = basic_path + "font/prstartk.ttf";
